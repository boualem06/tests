...
if __name__ == "__main__":
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/home/blm/learning/kafka_spark_project/checkpoints/checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/home/blm/learning/kafka_spark_project/checkpoints/checkpoint2") \
        .outputMode("update") \
        .start()
